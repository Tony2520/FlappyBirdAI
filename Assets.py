...
class Bird:
    ...
    def __init__(self,x,y):
        ...
        self.y = y
        self.tilt = 0
        self.tick_count = 0 #keeps track of ticks since last jumped
        self.vel = 0
        self.height = self.y
        self.img_count = 0
    ...
    def move(self):
        ...
        #d = vt * 1/2 at^2, a/gravity here is picked to be 3
    ...
    def draw(self,win):
        index = self.img_count // self.ANIMATION_TIME
